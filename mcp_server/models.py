...
#   timestamp: 2025-06-28T15:22:00+00:00
...
class CertificateParameters(BaseModel):
    ...
    PolicyNo: str = Field(..., description='PolicyNo', examples=['123'])
    PolicyType: str = Field(
        ..., description='PolicyType', examples=['Policy Copy,Endorsement Copy']
    )
...
class MiipcCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class MiipcCertificatePostResponse(BaseModel):
...
class MiipcCertificatePostResponse1(BaseModel):
...
class MiipcCertificatePostResponse2(BaseModel):
...
class MiipcCertificatePostResponse3(BaseModel):
...
class MiipcCertificatePostResponse4(BaseModel):
...
class MiipcCertificatePostResponse5(BaseModel):
...
class MiipcCertificatePostResponse6(BaseModel):
